...
table_spec = (
    'uplifted-kit-437502-g2:'
    'chinnaka_workshop2.chinnaka_dfsqltable_sales'
)
...
(p 
 | 'Read from PubSub' >> beam.io.ReadFromPubSub(
     topic="projects/uplifted-kit-437502-g2/topics/chinnaka-transactions"  # Change to your PubSub topic
 )
